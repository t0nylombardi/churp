...
ActiveRecord::Schema[7.2].define(version: 20_231_118_054_852) do
  ...
  create_table 'searchjoy_conversions', force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.index %w[convertable_type convertable_id], name: 'index_searchjoy_conversions_on_convertable'
  ...
  create_table 'searchjoy_searches', force: :cascade do |t|
    ...
    t.index %w[search_type created_at], name: 'index_searchjoy_searches_on_search_type_and_created_at'
    t.index %w[search_type normalized_query created_at], name: 'index_searchjoy_searches_on_search_type_query'
