module TweetsHelper
  ...
  def tweet_class(view, options = {})
    if view == :tweet
      "z-0 tweet-block border-b border-gray-200 dark:border-dim-200 hover:bg-gray-100 dark:hover:bg-dim-300 cursor-pointer transition duration-350 ease-in-out pb-4 border-l border-r #{options[:extended_classes]}"
    end
